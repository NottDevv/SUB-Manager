# 🚀 SUB-Manager Auto Deploy Wizard

یک ابزار تحت وب، هوشمند و یکپارچه برای راه‌اندازی و دپلوی خودکار **[SUB-Manager](https://github.com/NottDevv/SUB-Manager)** روی حساب Cloudflare Workers بدون نیاز به نصب هیچ‌گونه ابزار پیش‌نیاز یا دانش فنی!
...
- 🎨 **رابط کاربری مدرن و واکنش‌گرا (Responsive):** طراحی زیبا با Tailwind CSS، پشتیبانی از حالت شب و بهینه‌سازی کامل برای موبایل و دسکتاپ.
- 🌐 **پشتیبانی دو زبانه:** دارای سوئیچ لحظه‌ای بین زبان‌های **فارسی** و **English**.
- 🔐 **ایمنی و شفافیت بالا:** انجام تمام پردازش‌ها و درخواست‌های API به‌صورت مستقیم در سمت مرورگر شما (Client-Side).
